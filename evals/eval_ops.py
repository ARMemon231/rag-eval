...
# Pricing: Gemini 3.5 Flash Lite, USD per 1M tokens. Prices change --
# keep them here as constants, never buried in code, and re-check the provider's
# pricing page before trusting a budget.
PRICE_INPUT_PER_1M        = 0.075   # input per 1M tokens
PRICE_CACHED_INPUT_PER_1M = 0.01875 # cached (repeated prefix) input
PRICE_OUTPUT_PER_1M       = 0.30    # output per 1M tokens
